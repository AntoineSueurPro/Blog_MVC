        ...
        <div class="largeur90 m-auto">
            ...
            <div class="d-flex justify-content-center flex-column test_contenu">
                <div class="d-flex justify-content-center mb-4">
                    <h2 class="gros_h2 me-3"><?= $article['titre'] ?></h2>
                    <p class="text-center item-categorie selected"> <?= $article['categorie'] ?></p>
                </div>
                <?= $article['contenu'] ?>
            ...
            foreach ($commentaires as $commentaire) {
                ...
                <div class="d-flex w-75 m-auto">
                    ...
                    <div class="d-flex flex-column ms-3">
                        <div class="d-flex test-bottom">
                            <p>• Le <?= $commentaire['created_at'] ?></p>
            ...
            <div class="w-75 m-auto">
                ...
                if (isset($_SESSION['membre'])) { ?>
                    <form action="" method="POST">
                        ...
                        <p class="text-end mt-3"><input type="submit" class="bouton d-inline-block" value="Publier"></p>
                    </form>
